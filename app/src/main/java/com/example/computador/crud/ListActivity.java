...
public class ListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (userCoordinates.canGetLocation()) {
            ...
            alert.showAlertDialog(ListActivity.this, "GPS Status",
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent selectedPlace = new Intent(ListActivity.this, SelectedPlaceDetails.class);
        ...
        protected String doInBackground(String... args) {
            ...
            try{
                if(jsonObject.getString("status").equals("OK")){
                    ...
                    alert.showAlertDialog(ListActivity.this, "Near Places", "Sorry no places found.", false);
                }
